        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuCategories_Areas_AreaId",
                        column: x => x.AreaId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerIdentifier = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Variants = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    MenuCategoryId = table.Column<int>(type: "integer", nullable: false),
                    IsNoteRequired = table.Column<bool>(type: "boolean", nullable: false),
                    NoteSuggestion = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
